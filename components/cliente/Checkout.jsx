    ...
    <>
        ...
        {abierto === false && (
          <div className="ch-aviso-cerrado">
            ...
            <div>
              ...
              <span>
                {proxApertura ? `Abrimos ${proxApertura}. ` : ''}
                Podés armar tu pedido y confirmarlo apenas abramos.
              </span>
            </div>
          </div>
        )}
      ...
      <style jsx global>{`
        ...
        .ch-btn-avisar {
          ...
          background: #1a1510; color: #faf7f2; border: none; border-radius: 12px;
          padding: 15px; font-size: 15px; font-weight: 700; font-family: inherit; cursor: pointer;
        }
        .ch-btn-avisar:hover { filter: brightness(1.2); }
        .ch-avisando {
          display: flex; align-items: center; justify-content: center; gap: 8px;
          background: rgba(45,122,58,0.08); border: 1px solid rgba(45,122,58,0.25);
          color: #2d7a3a; border-radius: 12px; padding: 13px; font-size: 14px; font-weight: 600;
        }
        .ch-btn-cancelar-aviso {
          background: transparent; border: none; color: #9a8f82; font-size: 12px;
