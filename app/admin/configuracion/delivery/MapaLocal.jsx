    ...
    async function initMap() {
      ...
      const iconLocal = L.divIcon({
        html: `<div style="display:flex;flex-direction:column;align-items:center;cursor:grab">
          <div style="width:26px;height:26px;background:#c1320a;border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:3px solid #fff;box-shadow:0 3px 10px rgba(0,0,0,0.3)"></div>
        </div>`,
        className: '',
        iconAnchor: [13, 26],
      });
  ...
  return (
    <div className="wrap">
      ...
      <style jsx>{`
        ...
        .buscador input:focus { border-color: #c1320a; }
        .buscador button {
